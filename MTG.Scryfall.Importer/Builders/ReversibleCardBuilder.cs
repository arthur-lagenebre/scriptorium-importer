...
public class ReversibleCardBuilder : IScryfallBuilder
{
    ...
    public Layout Layout => new("reversible_card");

    private readonly IScryfallTypelineManager _typelineManager;

    public ReversibleCardBuilder(IScryfallTypelineManager typelineManager)
    {
