...
public class CardMapper : ICardMapper
{
    public CardDto Convert(Card card)
    {
        ...
        //cardDto.Names.AddRange(GetCardNames(card.OracleId, card.Name, card.CardFaces));
        //cardDto.Texts.AddRange(GetCardTexts(card.OracleId, card.Text, card.CardFaces));
        ////cardDto.Supertypes;
        ////cardDto.Types;
        ////cardDto.Subtypes;
        //cardDto.Faces.AddRange(GetCardFaces(card.OracleId, card.CardFaces));
        //cardDto.RelatedCards.AddRange(GetRelatedCards(card.OracleId, card.RelatedCards));
        ////cardDto.Sets;
